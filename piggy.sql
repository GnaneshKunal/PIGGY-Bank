...
CREATE TABLE `account` (
  ...
  `branch_branch_number` int(5) NOT NULL,
  `balance` decimal(10,2) NOT NULL,
  `assests` decimal(10,2) NOT NULL,
  `account_type` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`account_number`),
  KEY `branch_branch_number` (`branch_branch_number`),
  KEY `customer_id` (`customer_id`),
  CONSTRAINT `account_ibfk_1` FOREIGN KEY (`branch_branch_number`) REFERENCES `branch` (`bank_branch_number`),
...
CREATE TABLE `deposit` (
  ...
  CONSTRAINT `deposit_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`) ON UPDATE CASCADE,
  CONSTRAINT `deposit_ibfk_2` FOREIGN KEY (`account_number`) REFERENCES `account` (`account_number`) ON UPDATE CASCADE
...
CREATE TABLE `employee` (
  ...
  CONSTRAINT `employee_ibfk_1` FOREIGN KEY (`dependent_name`) REFERENCES `cutomer` (`customer_name`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `loan` (
  ...
  KEY `account_number` (`account_number`),
  KEY `customer_id` (`customer_id`),
  CONSTRAINT `loan_ibfk_1` FOREIGN KEY (`account_number`) REFERENCES `account` (`account_number`) ON UPDATE CASCADE,
  CONSTRAINT `loan_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=99561 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `loan` VALUES (99501,201,17000.00,401,0,'2016-01-05'),(99502,207,4500.00,407,0,'2016-10-05'),(99503,207,1500.00,407,0,'2016-10-05'),(99504,203,6000.00,403,0,'2016-11-05'),(99505,203,15000.00,403,0,'2016-11-05'),(99506,206,10000.00,406,0,'2016-01-05'),(99507,215,100000.00,415,0,'2016-02-05'),(99508,207,175000.00,407,0,'2016-03-05'),(99509,215,14500.00,406,0,'2016-04-05'),(99510,220,15000.00,420,0,'2016-05-05'),(99511,206,10000000.00,406,0,'2016-06-05'),(99512,215,15500.00,415,0,'2016-07-05'),(99513,215,3000000.00,415,0,'2016-11-05'),(99514,231,20000.00,431,0,'2016-11-05'),(99515,220,2400000.00,420,0,'2016-11-05'),(99516,226,21000.00,426,0,'2016-11-05'),(99517,226,4500.00,426,0,'2016-11-05'),(99518,222,4200.00,422,0,'2016-11-05'),(99519,225,1750.00,425,0,'2016-11-05'),(99520,218,6000.00,418,0,'2016-08-05'),(99521,233,6500.00,433,0,'2016-11-05'),(99522,233,7000.00,433,0,'2016-11-05'),(99523,218,11000.00,418,0,'2016-11-05'),(99524,237,22000.00,437,0,'2016-11-05'),(99525,237,30000.00,437,0,'2016-07-05'),(99526,240,1700000.00,440,0,'2016-11-05'),(99527,243,50000.00,443,0,'2016-11-05'),(99528,243,1500000.00,443,0,'2016-11-05'),(99529,240,40000.00,440,0,'2016-11-05'),(99530,245,75000.00,445,0,'2016-11-05'),(99531,247,12000.00,447,0,'2016-11-05'),(99532,248,11000.00,448,0,'2016-11-05'),(99533,248,12000.00,448,0,'2016-11-05'),(99534,249,21000.00,449,0,'2016-11-05'),(99535,251,10500.00,451,0,'2016-11-05'),(99536,220,61000.00,420,0,'2016-11-05'),(99537,231,1500000.00,431,0,'2016-11-05'),(99538,237,145000.00,437,0,'2016-11-05'),(99539,218,130000.00,418,0,'2016-11-05'),(99540,248,125000.00,448,0,'2016-11-05'),(99541,247,7500.00,447,0,'2016-11-05'),(99542,225,95000.00,425,0,'2016-11-05'),(99543,226,36000.00,426,0,'2016-11-05'),(99544,243,27000.00,443,0,'2016-11-05'),(99545,235,17000.00,435,0,'2016-11-05'),(99546,221,15000.00,421,0,'2016-11-05'),(99547,202,40000.00,402,1,'2016-03-05'),(99548,251,85000.00,451,1,'2016-07-05'),(99549,249,75000.00,449,1,'2016-02-05'),(99550,212,150000.00,412,1,'2016-11-05'),(99551,204,50000.00,404,0,'2016-11-05'),(99552,204,9000.00,404,0,'2016-11-05'),(99553,204,60000.00,404,0,'2016-11-05'),(99554,204,2000.00,404,0,'2016-11-07'),(99555,204,50000.00,404,0,'2016-11-08'),(99556,204,5000.00,404,0,'2016-11-08'),(99557,204,5000.00,404,0,'2016-11-08'),(99558,788,5000.00,789,0,'2016-11-08'),(99559,798,5000.00,789,0,'2016-11-08'),(99560,799,5000.00,789,0,'2016-11-08');
...
-- Dump completed on 2016-11-09 13:57:02
